...
public class FileStorage {
    private static final String BASE = System.getProperty("user.dir"); // relative to execution dir
    ...
    public static void saveCatalog(Catalog catalog) {
        ...
        } catch (IOException e) { System.err.println("Ошибка сохранения каталога: " + e.getMessage()); }
    }
    public static Catalog loadCatalog() {
        ...
        } catch (IOException | ClassNotFoundException e) { System.err.println("Ошибка загрузки каталога: " + e.getMessage()); return null; }
    }

    public static void saveOrders(List<Order> orders) {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(ORDERS_FILE))) {
            oos.writeObject(orders);
        } catch (IOException e) { System.err.println("Ошибка сохранения заказов: " + e.getMessage()); }
    }
    public static List<Order> loadOrders() {
        ...
        } catch (IOException | ClassNotFoundException e) { System.err.println("Ошибка загрузки заказов: " + e.getMessage()); return new ArrayList<>(); }
    }

    public static void saveBookings(List<Booking> bookings) {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(BOOKINGS_FILE))) {
            oos.writeObject(bookings);
        } catch (IOException e) { System.err.println("Ошибка сохранения бронирований: " + e.getMessage()); }
    }
    public static List<Booking> loadBookings() {
        ...
        } catch (IOException | ClassNotFoundException e) { System.err.println("Ошибка загрузки бронирований: " + e.getMessage()); return new ArrayList<>(); }
    }
}
